...
void menu(FILE *csvfile){
    ...
    printf("3 - Pesquisa de mediana de casos novos por ano e cidade (codigo do IBGE)\n");
    printf("4 - Pesquisa de mediana de obitos novos por ano e cidade (codigo do IBGE)\n");
    printf("5 - Sair\n");
